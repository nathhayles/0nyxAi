...
const TOOLS = [
  ...
  { id:"reframe360", icon:"🌐", label:"360° to Reel", desc:"Upload equirectangular footage from a GoPro Max or Insta360 — Onyx auto-tracks the person in frame and crops it into a normal reel.", route:"/reframe360", color:"#b48dff", available:false, badge:"Beta" },
];
