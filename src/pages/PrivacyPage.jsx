export default function PrivacyPage() {
  return (
    <div className="page" style={{ maxWidth: 800, margin: "0 auto", padding: "40px 24px", color: "#e2e8f0", fontFamily: "sans-serif", lineHeight: 1.7 }}>
      ...
      <p>When you connect a social media account (Instagram, TikTok, LinkedIn), we store an access token that allows us to publish content on your behalf. We only publish content when you explicitly initiate a publish action. We do not read your social media feed, contacts, or private messages. You can disconnect any social account at any time from your Account settings, which revokes our access.</p>
      ...
      <p>For privacy-related questions, contact us at <a href="mailto:support@onyx-reelz.com" style={{ color: "#7c3aed" }}>support@onyx-reelz.com</a>.</p>
    </div>
  );
}
