...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "How much does AI video generation cost?", a: "Cost depends on the model you choose. Wan 2.5 is 18 credits/scene, Vidu Q3 Pro is 84-167 credits/scene (based on the scene's actual length), Seedance 1 Pro is 20-40 credits/scene (based on the scene's actual length), Kling 3 Pro is ~75-150 credits/scene (based on the scene's actual length), Veo 3 is 140 credits/scene, and Seedance 2.0 is ~202-404 credits/scene (based on the scene's actual length). If a scene has narration/voiceover attached when you regenerate it in the editor, a lip-sync surcharge is added on top of the base cost — see the AI Lip-Sync section. Credits can be purchased (100 credits = $1) or earned through the referral program." },
      { q: "Which AI video model should I choose?", a: "Wan 2.5 (18 cr) is the cheapest option and great for quick, low-cost clips. Vidu Q3 Pro (84-167 cr, based on scene length) is also budget-friendly and good for quick clips. Seedance 1 Pro (20-40 cr, based on scene length) offers a balance of quality and cost. Kling 3 Pro (~75-150 cr, based on scene length) is our most popular model for high-quality cinematic output. Veo 3 (140 cr) is the premium option for the highest fidelity, especially for realism and motion. Seedance 2.0 (~202-404 cr, based on scene length) is our premium option with native audio generation. All are selectable in the Generate Model dropdown on the scene panel." },
    ]
  },
  {
