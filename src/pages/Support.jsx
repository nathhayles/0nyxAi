...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      { q: "How does the credit system work?", a: "Credits are used for AI features. 100 credits = $1. Credits never expire. AI video generation cost varies by model and scene length (8–606 credits per scene). Voiceover uses minutes from your plan allowance." },
