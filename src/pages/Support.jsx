...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { q: "Character Consistency vs. Scene Accuracy — what's the difference?", a: "When tagging a character with @name in a scene, you can set that scene's reference mode. Character Consistency anchors the generation to the character's reference photo, keeping their face and appearance accurate — best for a recognizable recurring character across multiple scenes. Scene Accuracy generates from the prompt/descriptor text instead, prioritizing your scene's described action, setting, and camera direction — the character's general look still applies, but their face may vary more between generations. Each character has a default reference mode, and you can override it per scene." },
